...
const messageData = new Uint8Array([0x06, 0x00, 0x01, 0x01, 0x42, 0x00, 0x02, 0xb2, 0x01, 0x00, 0x01]);
...
if (calculatedCrc !== 0x003c) {
  ...
  const messageDataNoId = new Uint8Array([0x06, 0x00, 0x01, 0x01, 0x00, 0x02, 0xb2, 0x01, 0x00, 0x01]);
